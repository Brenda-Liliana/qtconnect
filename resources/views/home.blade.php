		...
		<div class="container">
			<div class="col-md-6 col-md-offset-3" style="padding: 160px 0px;">
				<div class="inner-addon right-addon">
					<i class="glyphicon glyphicon-search big-search"></i>
					<input class="primary-search big-search" type="text" placeholder="Buscar" name="search">
				</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		alert();
	    $('#list').click(function(event){alert();event.preventDefault();$('#products .item').addClass('list-group-item');});
